...
转到你的 GitHub 项目页面上的 Actions 选项卡，选择"New workflow"，然后选择"Set up a workflow yourself"。将文件替换为下面的工作流程或 [Action 的示例](https://github.com/tauri-apps/tauri-action/tree/dev/examples)之一。
