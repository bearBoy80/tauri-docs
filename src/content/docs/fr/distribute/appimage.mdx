...
Consultez notre [guide GitHub Action](/fr/distribute/pipelines/github/#compilation-avec-arm-runner) pour un exemple de workflow qui exploite QEMU pour construire l'application. Notez que c'est extrêmement lent et recommandé uniquement dans les dépôts publics où les minutes de construction sont gratuites. Dans les dépôts privés, les runners ARM de GitHub devraient être plus rentables et beaucoup plus faciles à configurer.
