...
Alternativement, vous pouvez [ajouter Tauri à un projet existant](#configuration-manuelle-tauri-cli) pour transformer rapidement votre base de code existante en une application Tauri.
